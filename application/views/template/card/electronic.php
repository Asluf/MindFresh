...
foreach ($book as $item) {  ?>
    ...
    <div class="col-xs-6 product col-md-6  col-lg-3 " style="width: 49%;">
        <div class="">
            <a class="img-prod"  data-toggle="modal" data-target="#book<?php echo $item['Item_ID']; ?>">
    ...
    <div>
        <div class="modal fade" id="book<?php echo $item['Item_ID']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
