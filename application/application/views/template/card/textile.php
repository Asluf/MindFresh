    ...
    <div class="col-xs-6 product col-md-6  col-lg-3 " style="width: 49%;">
        <div class="">
            <a class="img-prod"  data-toggle="modal" data-target="#text<?php echo $item['Item_ID']; ?>">
                <img style="width: 150px; height:200px" src="<?php echo base_url(); ?>resources/textile_pics/<?php echo $item['Item_Image_Path']; ?>" alt="Colorlib Template">
            </a>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <img style="width: 250px;" src="<?php echo base_url(); ?>resources/textile_pics/<?php echo $item['Item_Image_Path']; ?>" alt="Colorlib Template"><br />
